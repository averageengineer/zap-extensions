...
import org.zaproxy.addon.myaddon.ExtensionMyAddOn;
...
public class RightClickMsgMenu extends PopupMenuItemHttpMessageContainer {
    ...
    private ExtensionMyAddOn extension;

    public RightClickMsgMenu(ExtensionMyAddOn ext, String label) {
        super(label);
        /*
        ...
        View.getSingleton()
                .showMessageDialog(
                        Constant.messages.getString(
                                ExtensionMyAddOn.PREFIX + ".popup.msg",
